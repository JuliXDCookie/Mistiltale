...
def CreatePlayer():
    ...
    if dataT["Temp"]["SkipLoop"] != 1:
        ...
        while loop == 1:
            ...
            print("------------------------------")
            print("╔════════════════════╗ ╔════════════════════╗ ╔════════════════════╗")
            print("║ Swordsman:         ║ ║ Archer:            ║ ║ Mage:              ║")
            print("║ Weapon Type: Sword ║ ║ Weapon Type: Bow   ║ ║ Weapon Type: Wand  ║")
            print("║                    ║ ║                    ║ ║                    ║")
            print("║ HP: 45             ║ ║ HP: 35             ║ ║ HP: 30             ║")
            print("║ SP: 20             ║ ║ SP: 20             ║ ║ SP: 30             ║")
            print("║ ATK: 8             ║ ║ ATK: 6             ║ ║ ATK: 8             ║")
            print("║ DEF: 8             ║ ║ DEF: 5             ║ ║ DEF: 4             ║")
            print("║ SPD: 4             ║ ║ SPD: 8             ║ ║ SPD: 6             ║")
            print("╚════════════════════╝ ╚════════════════════╝ ╚════════════════════╝")
            print("------------------------------")
            print("Commands:")
